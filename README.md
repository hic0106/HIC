...
- 차트: 5분·15분·1시간·4시간·1일 버튼 + [기타]에서 1분~1개월 모든 간격. 기타 간격은 현재가로 마지막 캔들을 갱신하고, 마감 후 REST로 확정값을 받습니다.
- 코인 전략(터틀·ADX·TSMOM·Rayner) 캔들은 Binance 전 간격 선택 가능: 1분·3분·5분·15분·30분·1시간·2시간·4시간·6시간·8시간·12시간·1일·3일·1주·1개월. 실시간은 사용 중인 간격만 1000봉 유지(5분·15분·1시간·4시간은 WebSocket, 나머지는 마감 직후 REST 조회). 30분 이하 캔들은 백테스트 기간이 약 26,000봉으로 제한(1분 18일, 3분 54일, 5분 90일, 15분 270일, 30분 541일). 과거 데이터 요청은 분당 150회 이하로 조절합니다. QQQ 전략은 미국 정규장 세션 캔들 고정입니다.
